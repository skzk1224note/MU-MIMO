...
for isnr = 1:LSNR
    ...
    E_BDAS  = zeros(Ntri, NRs*NU);                % ZFの固有値
    ...
    for k = 1:Ntri              % 試行回数のループ
        ...
        a=NT/(10^(SN_tar/10));
        [W_BMSNGE,U_BMSNGE,S_BMSNGE,RIPGE] = bmsn_ge(NT,NR,NU,H0,a); % function, bmsn_ge.m を使用
...
legend('BMSN-BF','BMSN-GE','BD','ZF','BD-AS','Location','Northwest');
